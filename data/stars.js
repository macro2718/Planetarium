export const BASE_STAR_DATA = [
    ...
    },
    {
        ...
        color: 0xb5d0ff,
        glowColor: 0x8bb5ff,
        info: 'さんかく座β星デルタトゥム。青白い光で北辺を伸ばし、三角形の角を尖らせる。',
        featured: false
    },
    {
        id: 'gammaTri',
    ...
    },
    {
        ...
        color: 0xfff4da,
        glowColor: 0xffe8b5,
        info: 'や座α星シャム。矢じりにあたる黄白色の星で、矢全体の進行方向を定める。',
        featured: false
    },
    {
        id: 'betaSge',
    ...
    },
    {
        ...
        color: 0xa8c8ff,
        glowColor: 0x70a0ff,
        info: 'ほ座γ星レゴル。熱い青白い光で帆の基部を示し、南天で目立つ連星。',
        featured: false
    },
    {
        id: 'alsephina',
        ...
        color: 0xb5d0ff,
        glowColor: 0x8bb5ff,
        info: 'ほ座δ星アルセフィナ。帆の一辺で白く輝き、アルゴ船の帆布を張る。',
        featured: false
    },
    {
        id: 'suhail',
        ...
        color: 0xffc58f,
        glowColor: 0xff9050,
        info: 'ほ座λ星スハイル。橙色の超巨星で、帆柱の高い位置から甲板を照らす。',
        featured: false
    },
    {
        id: 'markeb',
        ...
        color: 0xb5d0ff,
        glowColor: 0x8bb5ff,
        info: 'ほ座κ星マルケブ。帆の南側を青白くなぞり、航海する船の輪郭を引く。',
        featured: false
    },
    {
        id: 'muVel',
    ...
    },
    {
        ...
        color: 0xa8c8ff,
        glowColor: 0x70a0ff,
        info: 'とも座ζ星ナオス。極めて高温な青色超巨星で、アルゴ船の船首を蒼白く照らす。',
        featured: false
    },
    {
        id: 'ahadi',
        ...
        color: 0xfff4da,
        glowColor: 0xffe8b5,
        info: 'とも座π星アハディ。黄白い光で船体中央を彩り、穏やかな航跡を描く。',
        featured: false
    },
    {
        id: 'tureis',
        ...
        color: 0xfff4da,
        glowColor: 0xffe8b5,
        info: 'とも座ρ星トゥレイス。舵を意味する名を持ち、船尾の方向を落ち着いた光で示す。',
        featured: false
    },
    {
        id: 'etaPup',
        ...
        color: 0xb5d0ff,
        glowColor: 0x8bb5ff,
        info: 'とも座η星。青白い巨星が舷側のラインを明るくし、ナオスと舵をつなぐ。',
        featured: false
    },
    {
        id: 'asmidiske',
        ...
        color: 0xb5d0ff,
        glowColor: 0x8bb5ff,
        info: 'とも座ξ星アズミディスケ。かつて帆座と共有された名で、甲板中央を結ぶ。',
        featured: false
    }
];
